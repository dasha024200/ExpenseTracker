...
- [x] Crear диаграми класів і послідовності
- [x] Ініціалізувати solution з коректною структурою
- [ ] Реалізувати Domain layer з 5-8 класами
- [ ] Реалізувати контракти (інтерфейси репозиторіїв)
- [ ] Реалізувати перший вертикальний зріз
- [ ] Додати базові юніт-тести (мінімум 5)
...
- [ ] Робоча консольна програма з одним повним сценарієм
- [ ] Мінімум 5 юніт-тестів
- [ ] Налаштований CI/CD (GitHub Actions)
- [ ] .gitignore та README
- [ ] docs/iteration-1.md (передача на наступну ітерацію)
...
### Завдання:
- [ ] Реалізувати persistence (збереження у файл JSON)
- [ ] Додати LINQ-запити для фільтрації та сортування
- [ ] Реалізувати мінімум 3 use cases
- [ ] Додати обробку помилок при роботі з файлами
- [ ] Розширити набір тестів
- [ ] Оновити діаграми та backlog
...
## Теми курсу, які повинні проявитися в проєкті
...
Кожна наступна ітерація будує на артефактах попередньої, не перезапускаючи проєкт з нуля.
